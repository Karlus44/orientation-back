...
app.get('/getconfigvar', cors(corsOptions), (req,res) => res.json({url:process.env.CLOUDCUBE_URL}))
app.post('/delete_user', cors(corsOptions), (req,res) => {delete_user.handleDeleteUser(req,res, db,AWS)})
app.post('/delete_file', cors(corsOptions), (req,res) => {delete_file.handleDeleteFile(req,res, db)})
app.post('/delete_folder', cors(corsOptions), (req,res) => {delete_file.handleDeleteFolder(req,res,AWS)})
app.post('/copy_file', cors(corsOptions), (req,res) => {copy_file.handleCopyFile(req,res, db)})
app.post('/copy_folder', cors(corsOptions), (req,res) => {copy_file.handleCopyFolder(req,res,db,AWS)})
